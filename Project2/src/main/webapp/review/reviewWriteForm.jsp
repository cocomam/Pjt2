	...
	<form action="" name="">
		<div class="example" align="center">
			...
			<table class="board_table">
				<tr>
					<th class="subject">SUBJECT <select name="job">
			...
			<div class="btnArea ">
	            <!-- <span class="left displaynone"><a href="#none" onclick=""><span class="button tt romi_btn white">관리자답변보기</span></a></span> -->
	            <a id="link" href="#"><span class="left">목록</span></a>
				<a id="link" href="#"><span class="button s white">등록</span></a> 
				<a id="link" href="#"><span class="button s cancel">취소</span></a>
       		</div>
		</div>
	</form>
</body>
