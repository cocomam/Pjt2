	...
	<div id="top">
		<div class="top_info">
			<div class="top_info_left">
				<ul>
					<li onclick="location.href='/Project2/main/index.jsp?req=noticeList'" style="list-style:none;  width: 85px;" class="list" onmouseover="this.innerHTML='공지사항'" onmouseout="this.innerHTML='NOTICE|'" >NOTICE|</li>
					<li  onclick="location.href='/Project2/main/index.jsp?req=qnaList'" style="list-style:none; width: 85px;" class="list" onmouseover="this.innerHTML='문의사항'" onmouseout="this.innerHTML='Q&amp;A|'" >Q&amp;A|</li>
					<li onclick="location.href='/Project2/main/index.jsp?req=reviewList'" style="list-style:none; width: 85px;" class="list" onmouseover="this.innerHTML='구매후기'" onmouseout="this.innerHTML='REVIEW|'">REVIEW|</li>
				</ul>
			</div>
			
			<div class="top_info_right">
					<a href="/Project2/main/index.jsp?req=insertForm" class="insert" >상품등록|</a> 
					<a href="/Project2/main/index.jsp?req=loginForm" class="log" >login|</a> 
					<a href=" " class="logout" >logout|</a> 
					<a href="" class="join">join us|</a>
					<a href="" class="cart">cart <span class="orderCart">(0)|</span> </a>
					<a href="/Project2/main/index.jsp?req=order">order|</a>
					<a href="/Project2/main/index.jsp?req=myPage">my page</a>
			</div>
		</div>
...
<div id="full_main">
	...
	<div id="content">
		...
		<c:if test="${param.req=='loginForm'}">
			<jsp:include page="../board/loginForm.jsp" />
		</c:if>
		
		<!-- 상품등록화면 -->
		<c:if test="${param.req=='insertForm'}">
			<jsp:include page="../board/insertForm.jsp" />
		</c:if>
		
		<!-- myPage -->
		<c:if test="${param.req=='myPage'}">
			<jsp:include page="../board/myPage.jsp" />
		</c:if>
		
		<!-- order -->
		<c:if test="${param.req=='order'}">
			<jsp:include page="../board/order.jsp" />
		</c:if>
